...
$modalidad_final = $_POST['modalidad_final'];
...
if ($complementos == true) {
    ...
    case 2:
        {
            include 'nuevaHoja.php';
            $subtotal = ($importe_producto + $subtotal_complemento) * 11;
            break;
        }
    case 3:
        {
            ...
            $subtotal = ($importe_producto + $subtotal_complemento * 21);
            break;
        }
    default:
        {
