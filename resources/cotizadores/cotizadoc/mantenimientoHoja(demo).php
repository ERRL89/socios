...
$pdf->Cell(186, 10, 'PÓLIZA DE MANTENIMIENTO ', 0, 0, 'R');
...
///////// COMIENZA CONTENIDO /////////
        $cantidad_complemento_txt = 1;
        $nombre_complemento = "PÓLIZA DE MANTENIMIENTO ANUAL\nIncluye:\nRefacciones incluidas.\nSoporte técnico premier.\nPrioridad de atención gold.\n2 visitas de mantenimiento preventivo y correctivo";
...
//
$subtotal_mensual = 1950;
//
$mantenimientos = $subtotal_mensual * 11.5;
$refacciones = $subtotal_mensual * 7.5;
$visitas = 3000;

$subtotal = $mantenimientos + $refacciones + $visitas;
$subtotal = $subtotal / 3;
...
$pdf->SetTextColor(0, 0, 0);
$pdf->MultiCell(90, 28, $texto_term_venta, 0, 'J', 0, 0, '', '', true, 0, false, true, 28, 'M');
////// TYC //////
